    ...
    <div class="strona">
        ...
        <div class="content">
            <div class="index-content">
                ...
                <!-- <h2>Strona zakładu fryzjerskiego</h2>
                <p>Witamy na naszej stronie</p> -->
                <?php
                    if($status && $rola!=2)
                    {
                        echo "<div class='index-przycisk'><a onclick=\"rezerwacja()\">Umów wizytę</a></div>";
                    }
                    elseif($status)
                    {
                        echo "<div class='index-przycisk'><a href='uslugi.php'>Umów wizytę</a></div>";
                    }
                    else
                    {
                        echo "<div class='index-przycisk'><a href='log.php'>Zaloguj/zarejestruj się</a></div>";
                        echo "<div class='index-przycisk'><a href='uslugi.php'>Sprawdź naszą ofertę</a></div>";
                    }
                    if($status && $rola!=2)
                    {
                        echo "<div class='index-przycisk'><a href='klienci.php'>Baza klientow</a></div>";
                    }
                ?>                
            </div>
        </div>
