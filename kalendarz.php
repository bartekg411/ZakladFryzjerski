        ...
        <div class="content">
            <div class="calendar">
                <?php
                    ...
                    echo "<table>
                        <tr><th><a href='?miesiac=".(($miesiac-1)==0 ? $miesiac+11 : $miesiac-1)."&rok=".(($miesiac-1)==0 ? $rok-1 : $rok)."&usluga=$_GET[usluga]'>&#129144;</a></th> 
                        <th id='calendar-month' colspan='5'><h2>".$miesiace[$miesiac-1]." $rok</h2></th> 
                        <th><a href='?miesiac=".(($miesiac+1)==13 ? $miesiac-11 : $miesiac+1)."&rok=".(($miesiac+1)==13 ? $rok+1 : $rok)."&usluga=$_GET[usluga]'>&#129146;</a></th></tr>";
        
                    for($i = 1; $i<=$dniwmiesiacu;$i++) //wypisanie dni
                    {
                        ...
                        {
                            echo "class='calendar-day'><a href='../dzien.php/?dzien=$i&miesiac=$miesiac&rok=$rok&usluga=$_GET[usluga]'>$i</a></td>";
                        }
                        else
                        {
